...
C:\Users\Devdatta Thorat>mongosh
Current Mongosh Log ID: 69e0b73d6bf1a901e23682d0
...
------
   ...
   2026-04-16T09:48:30.963+05:30: Access control is not enabled for the database. Read and write access to data and configuration is unrestricted
------
...
db> db.createCollection("Students")
{ ok: 1 }
db> db.insertOne({s_id:1,s_name:'devdatta'})
TypeError: db.insertOne is not a function
db> db.student.insertOne({s_id:1,s_name:'devdatta'})
{
  acknowledged: true,
  insertedId: ObjectId('69e0b8b56bf1a901e23682d1')
}
db> db.student.insertMany([{s_id:1,s_name:'devdatta'},{s_id:2,s_name:'arv'},{s_id:3,s_name:'bhav'}])
{
  acknowledged: true,
  insertedIds: {
    '0': ObjectId('69e0b9466bf1a901e23682d2'),
    '1': ObjectId('69e0b9466bf1a901e23682d3'),
    '2': ObjectId('69e0b9466bf1a901e23682d4')
  }
}
db> db.student.find()
[
  {
    _id: ObjectId('69e0b8b56bf1a901e23682d1'),
    s_id: 1,
    s_name: 'devdatta'
  },
  {
    _id: ObjectId('69e0b9466bf1a901e23682d2'),
    s_id: 1,
    s_name: 'devdatta'
  },
  { _id: ObjectId('69e0b9466bf1a901e23682d3'), s_id: 2, s_name: 'arv' },
  { _id: ObjectId('69e0b9466bf1a901e23682d4'), s_id: 3, s_name: 'bhav' }
]
db>
...
[
  ...
  },
  {
    ...
    isbn: '1935182234',
    pageCount: 375,
    publishedDate: ISODate('2012-06-04T07:00:00.000Z'),
...
db> db.resturant.find()

db> db.restuarant.find()
...
student
Students
db> db.restaurants.find()
[
  {
    _id: ObjectId('69e0b38d737faa68c49baf7d'),
    address: {
      building: '1007',
  ...
  {
    _id: ObjectId('69e0b38d737faa68c49baf7e'),
    address: {
      building: '469',
    ...
    grades: [
      ...
      { date: ISODate('2014-07-01T00:00:00.000Z'), grade: 'B', score: 23 },
      { date: ISODate('2013-04-30T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2012-05-08T00:00:00.000Z'), grade: 'A', score: 12 }
    ],
    name: "Wendy'S",
    restaurant_id: '30112340'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf7f'),
    address: {
      building: '351',
    ...
    grades: [
      ...
      { date: ISODate('2013-07-22T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2012-07-31T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2011-12-29T00:00:00.000Z'), grade: 'A', score: 12 }
    ],
    name: 'Dj Reynolds Pub And Restaurant',
    restaurant_id: '30191841'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf80'),
    address: {
      building: '2780',
    ...
    grades: [
      ...
      { date: ISODate('2012-04-13T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2011-10-12T00:00:00.000Z'), grade: 'A', score: 12 }
    ],
    name: 'Riviera Caterer',
    restaurant_id: '40356018'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf81'),
    address: {
      building: '97-22',
    ...
    grades: [
      { date: ISODate('2014-11-24T00:00:00.000Z'), grade: 'Z', score: 20 },
  ...
  {
    _id: ObjectId('69e0b38d737faa68c49baf82'),
    address: {
      building: '8825',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-11-15T00:00:00.000Z'), grade: 'Z', score: 38 },
      { date: ISODate('2014-05-02T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2013-03-02T00:00:00.000Z'), grade: 'A', score: 7 },
      { date: ISODate('2012-02-10T00:00:00.000Z'), grade: 'A', score: 13 }
    ],
    name: 'Brunos On The Boulevard',
    restaurant_id: '40356151'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf83'),
    address: {
      building: '2206',
  ...
  {
    _id: ObjectId('69e0b38d737faa68c49baf84'),
    address: {
      building: '7114',
    ...
    grades: [
      { date: ISODate('2014-05-29T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2014-01-14T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2013-08-03T00:00:00.000Z'), grade: 'A', score: 8 },
      { date: ISODate('2012-07-18T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2012-03-09T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2011-10-14T00:00:00.000Z'), grade: 'A', score: 9 }
    ],
    name: "Wilken'S Fine Food",
    restaurant_id: '40356483'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf85'),
    address: {
      building: '6409',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-07-18T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2013-07-30T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2013-02-13T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2012-08-16T00:00:00.000Z'), grade: 'A', score: 2 },
      { date: ISODate('2011-08-17T00:00:00.000Z'), grade: 'A', score: 11 }
    ],
    name: 'Regina Caterers',
    restaurant_id: '40356649'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf86'),
    address: {
      building: '1839',
    ...
    grades: [
      { date: ISODate('2014-07-14T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2013-07-10T00:00:00.000Z'), grade: 'A', score: 8 },
      { date: ISODate('2012-07-11T00:00:00.000Z'), grade: 'A', score: 5 },
      { date: ISODate('2012-02-23T00:00:00.000Z'), grade: 'A', score: 8 }
    ],
    name: 'Taste The Tropics Ice Cream',
    restaurant_id: '40356731'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf87'),
    address: {
      building: '2300',
  ...
  {
    _id: ObjectId('69e0b38d737faa68c49baf88'),
    address: {
      building: '7715',
  ...
  {
    _id: ObjectId('69e0b38d737faa68c49baf89'),
    address: {
      building: '1269',
    ...
    cuisine: 'Chinese',
    grades: [
      { date: ISODate('2014-09-16T00:00:00.000Z'), grade: 'B', score: 21 },
      { date: ISODate('2013-08-28T00:00:00.000Z'), grade: 'A', score: 7 },
      { date: ISODate('2013-04-02T00:00:00.000Z'), grade: 'C', score: 56 },
      { date: ISODate('2012-08-15T00:00:00.000Z'), grade: 'B', score: 27 },
      { date: ISODate('2012-03-28T00:00:00.000Z'), grade: 'B', score: 27 }
    ],
    name: 'May May Kitchen',
    restaurant_id: '40358429'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf8a'),
    address: {
      building: '1',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-05-07T00:00:00.000Z'), grade: 'A', score: 3 },
      { date: ISODate('2013-05-03T00:00:00.000Z'), grade: 'A', score: 4 },
      { date: ISODate('2012-04-30T00:00:00.000Z'), grade: 'A', score: 6 },
      { date: ISODate('2011-12-27T00:00:00.000Z'), grade: 'A', score: 0 }
    ],
    name: '1 East 66Th Street Kitchen',
    restaurant_id: '40359480'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf8b'),
    address: {
      building: '705',
    ...
    cuisine: 'Jewish/Kosher',
    grades: [
      { date: ISODate('2014-11-10T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2013-10-10T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2012-10-04T00:00:00.000Z'), grade: 'A', score: 7 },
      { date: ISODate('2012-05-21T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2011-12-30T00:00:00.000Z'), grade: 'B', score: 19 }
    ],
    name: 'Seuda Foods',
    restaurant_id: '40360045'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf8c'),
    address: {
      building: '203',
    ...
    cuisine: 'Ice Cream, Gelato, Yogurt, Ices',
    grades: [
      { date: ISODate('2014-02-10T00:00:00.000Z'), grade: 'A', score: 2 },
      { date: ISODate('2013-01-02T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2012-01-09T00:00:00.000Z'), grade: 'A', score: 3 },
      { date: ISODate('2011-11-07T00:00:00.000Z'), grade: 'P', score: 12 },
      { date: ISODate('2011-07-21T00:00:00.000Z'), grade: 'A', score: 13 }
    ],
    name: 'Carvel Ice Cream',
    restaurant_id: '40360076'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf8d'),
    address: {
      building: '265-15',
    ...
    cuisine: 'Ice Cream, Gelato, Yogurt, Ices',
    grades: [
      { date: ISODate('2014-10-28T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2013-09-18T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2012-09-20T00:00:00.000Z'), grade: 'A', score: 13 }
    ],
    name: 'Carvel Ice Cream',
    restaurant_id: '40361322'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf8e'),
    address: {
      building: '6909',
    ...
    cuisine: 'Delicatessen',
    grades: [
      { date: ISODate('2014-08-21T00:00:00.000Z'), grade: 'A', score: 4 },
      { date: ISODate('2014-03-05T00:00:00.000Z'), grade: 'A', score: 3 },
      { date: ISODate('2013-01-10T00:00:00.000Z'), grade: 'A', score: 10 }
    ],
    name: 'Nordic Delicacies',
    restaurant_id: '40361390'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf8f'),
    address: {
      building: '522',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-09-02T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2013-12-19T00:00:00.000Z'), grade: 'B', score: 16 },
      { date: ISODate('2013-05-28T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2012-12-07T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2012-03-29T00:00:00.000Z'), grade: 'A', score: 11 }
    ],
    name: 'Glorious Food',
    restaurant_id: '40361521'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf90'),
    address: {
      building: '284',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-11-19T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2013-11-14T00:00:00.000Z'), grade: 'A', score: 2 },
      { date: ISODate('2012-12-05T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2012-05-17T00:00:00.000Z'), grade: 'A', score: 11 }
    ],
...
Type "it" for more
db> db.restaurants.find({building:'284'})

db> db.restaurants.find({building: '284'})

db> db.restaurants.find({name: 'Glorious Food'})
[
  {
    _id: ObjectId('69e0b38d737faa68c49baf8f'),
    address: {
...
db> db.restaurants.find({name: 'The Movable Feast',grade:"A"})

db> db.restaurants.find({ cuisine: 'American '})
[
  {
    _id: ObjectId('69e0b38d737faa68c49baf80'),
    address: {
  ...
  {
    _id: ObjectId('69e0b38d737faa68c49baf95'),
    address: {
      building: '730',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-09-12T00:00:00.000Z'), grade: 'B', score: 26 },
      { date: ISODate('2013-08-28T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2013-03-25T00:00:00.000Z'), grade: 'B', score: 20 },
      { date: ISODate('2012-02-14T00:00:00.000Z'), grade: 'A', score: 12 }
    ],
    name: 'P & S Deli Grocery',
    restaurant_id: '40362264'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf96'),
    address: {
      building: '18',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-04-03T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2013-04-05T00:00:00.000Z'), grade: 'A', score: 4 },
      { date: ISODate('2012-03-21T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2011-04-27T00:00:00.000Z'), grade: 'A', score: 5 }
    ],
    name: 'Angelika Film Center',
    restaurant_id: '40362274'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf9b'),
    address: {
      building: '107',
    ...
    grades: [
      { date: ISODate('2014-07-18T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2014-02-26T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2013-08-26T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2013-02-01T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2012-01-17T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2011-10-18T00:00:00.000Z'), grade: 'A', score: 11 }
    ],
    name: 'Downtown Deli',
    restaurant_id: '40363021'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49baf9e'),
    address: {
      building: '7615',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-12-04T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2013-10-24T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2013-04-18T00:00:00.000Z'), grade: 'A', score: 5 },
      { date: ISODate('2012-04-05T00:00:00.000Z'), grade: 'A', score: 13 }
    ],
    name: 'Mejlander & Mulgannon',
    restaurant_id: '40363117'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafa1'),
    address: {
      building: '625',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-06-09T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2014-01-10T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2012-12-07T00:00:00.000Z'), grade: 'A', score: 4 },
      { date: ISODate('2011-12-13T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2011-09-09T00:00:00.000Z'), grade: 'A', score: 13 }
    ],
    name: 'Cafe Metro',
    restaurant_id: '40363298'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafa6'),
    address: {
      building: '87-69',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-02-25T00:00:00.000Z'), grade: 'A', score: 7 },
      { date: ISODate('2013-08-14T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2012-08-07T00:00:00.000Z'), grade: 'A', score: 7 },
      { date: ISODate('2012-03-26T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2011-11-04T00:00:00.000Z'), grade: 'A', score: 0 },
      { date: ISODate('2011-06-29T00:00:00.000Z'), grade: 'A', score: 4 }
    ],
    name: 'Snack Time Grill',
    restaurant_id: '40363590'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafa9'),
    address: {
      building: '437',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-06-03T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2013-06-07T00:00:00.000Z'), grade: 'A', score: 5 },
      { date: ISODate('2012-06-29T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2012-02-06T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2011-06-23T00:00:00.000Z'), grade: 'A', score: 13 }
    ],
    name: 'Berkely',
    restaurant_id: '40363685'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafaa'),
    address: {
      building: '1031',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-02-05T00:00:00.000Z'), grade: 'A', score: 0 },
      { date: ISODate('2013-01-29T00:00:00.000Z'), grade: 'A', score: 3 },
      { date: ISODate('2011-12-08T00:00:00.000Z'), grade: 'A', score: 10 }
    ],
    name: "Sonny'S Heros",
    restaurant_id: '40363744'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafae'),
    address: {
      building: '364',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-09-04T00:00:00.000Z'), grade: 'B', score: 20 },
      { date: ISODate('2014-02-26T00:00:00.000Z'), grade: 'B', score: 23 },
      { date: ISODate('2013-03-25T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2012-02-21T00:00:00.000Z'), grade: 'A', score: 8 }
    ],
    name: 'Spoon Bread Catering',
    restaurant_id: '40364179'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafb0'),
    address: {
      building: '0',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-05-16T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2013-05-10T00:00:00.000Z'), grade: 'A', score: 10 },
      { date: ISODate('2012-05-15T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2011-11-02T00:00:00.000Z'), grade: 'C', score: 32 }
    ],
    name: 'Terminal Cafe/Yankee Clipper',
    restaurant_id: '40364262'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafb7'),
    address: {
      building: '1',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-10-16T00:00:00.000Z'), grade: 'B', score: 24 },
      { date: ISODate('2014-05-02T00:00:00.000Z'), grade: 'A', score: 4 },
      { date: ISODate('2013-04-02T00:00:00.000Z'), grade: 'A', score: 13 },
      { date: ISODate('2012-10-19T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2012-04-27T00:00:00.000Z'), grade: 'B', score: 17 },
      { date: ISODate('2011-11-29T00:00:00.000Z'), grade: 'A', score: 11 }
    ],
    name: 'Metropolitan Club',
    restaurant_id: '40364347'
  },
  {
    _id: ObjectId('69e0b38d737faa68c49bafb8'),
    address: {
      building: '837',
    ...
    cuisine: 'American ',
    grades: [
      { date: ISODate('2014-07-22T00:00:00.000Z'), grade: 'B', score: 19 },
      { date: ISODate('2013-09-26T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2013-02-26T00:00:00.000Z'), grade: 'A', score: 11 },
      { date: ISODate('2012-04-30T00:00:00.000Z'), grade: 'A', score: 8 },
      { date: ISODate('2011-10-05T00:00:00.000Z'), grade: 'A', score: 12 }
    ],
...
db> db.restaurants.find({ "grades.score": {$gt:5}})
[
  {
    _id: ObjectId('69e0b38d737faa68c49baf7d'),
    address: {
  ...
  {
    _id: ObjectId('69e0b38d737faa68c49baf91'),
    address: {
      building: '129-08',
    ...
    cuisine: 'Delicatessen',
    grades: [
      { date: ISODate('2014-08-16T00:00:00.000Z'), grade: 'A', score: 12 },
      { date: ISODate('2013-08-27T00:00:00.000Z'), grade: 'A', score: 9 },
      { date: ISODate('2012-09-20T00:00:00.000Z'), grade: 'A', score: 7 },
      { date: ISODate('2011-09-29T00:00:00.000Z'), grade: 'A', score: 10 }
    ],
    name: "Sal'S Deli",
