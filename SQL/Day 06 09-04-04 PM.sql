...
# ====================================
alter table emp_1 rename employees;
...
SELECT * 
FROM EMPLOYEES
WHERE SALARY >= 2100 AND SALARY <=2500;

# =============================================================# =============================================================
# ================================================ BETWEEN & OR STATEMENT =============================================================
# =============================================================# =============================================================
...
select minimum_reorder_quantity 
from products
where minimum_reorder_quantity  between 5 and 30;
...
select * 
from employees
where salary > 10000 and department_id in (80 , 90, 100);

select * 
from employees
where salary > 10000 and department_id not in (80 , 90, 100);
